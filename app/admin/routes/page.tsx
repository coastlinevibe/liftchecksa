                ...
                <div className="flex items-start justify-between gap-3">
                  <div className="min-w-0">
                    <div className="mb-1 flex items-center gap-2">
                      ...
                      {pendingApplications > 0 ? (
                        <div className="inline-flex items-center gap-2 rounded-xl border border-amber-300 bg-white px-3 py-1.5 shadow-sm">
                          <div className="relative flex h-7 w-7 items-center justify-center rounded-lg bg-amber-100 text-amber-800">
                          ...
                          <div className="text-[11px] font-bold uppercase tracking-wide text-amber-900">Pending</div>
                        </div>
                      ) : null}
                    </div>
                    ...
                    <div className="mt-2 flex flex-wrap items-center gap-2 text-[11px]">
                      ...
                      {pendingApplications > 0 ? (
                        <span className="rounded-full border border-amber-300 bg-amber-50 px-2.5 py-1 font-bold text-amber-900">
